...
export type CreateTask = import("@/application/entities/tasks/create-task.dto").CreateTaskDto & {
  recurrence?: import("@/application/entities/tasks/task.entity").Recurrence;
  reminder?: import("@/application/entities/tasks/task.entity").Reminder;
};
...
export interface TaskRepositoryInterface {
  create(data: CreateTask): Promise<import("@/application/entities/tasks/task.entity").Task>;
  findById(id: string): Promise<import("@/application/entities/tasks/task.entity").Task | null>;
  findMany(
    filters?: TaskQueryFilters,
  ): Promise<import("@/application/entities/tasks/task.entity").Task[]>;
  update(
    id: string,
    data: UpdateTask,
  ): Promise<import("@/application/entities/tasks/task.entity").Task>;
