"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="69609e31-6c45-5616-baec-84fac9b6b050")}catch(e){}}();
...
exports.default = ({ app }) => {
     ...
     */
    app.get(formatRoute("/status"), rateLimit_1.RateLimitManager.getInstance().getDefaultLimiter(), administrator_1.IPBlocker.getInstance().getMiddleware(), status.getStatus);
    /**
     ...
     */
    app.get(formatRoute("/discord/status"), rateLimit_1.RateLimitManager.getInstance().getDefaultLimiter(), administrator_1.IPBlocker.getInstance().getMiddleware(), discordController.getStatus);
    /**
     ...
     */
    app.get(formatRoute("/discord/updates"), rateLimit_1.RateLimitManager.getInstance().getDefaultLimiter(), administrator_1.IPBlocker.getInstance().getMiddleware(), discordController.getUpdates);
    /**
     ...
     */
    app.get(formatRoute("/discord/incidents"), rateLimit_1.RateLimitManager.getInstance().getDefaultLimiter(), administrator_1.IPBlocker.getInstance().getMiddleware(), discordController.getIncidents);
    /**
     ...
     */
    app.get(formatRoute("/discord/recent"), rateLimit_1.RateLimitManager.getInstance().getDefaultLimiter(), administrator_1.IPBlocker.getInstance().getMiddleware(), async (_req, res) => {
        try {
...
//# debugId=69609e31-6c45-5616-baec-84fac9b6b050
