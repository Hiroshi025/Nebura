"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="b58cd2f4-0980-5fa9-a04b-a694d9627051")}catch(e){}}();
...
class IPBlockController {
    ...
    async blockIP(req, res) {
        try {
            ...
            await administrator_1.IPBlocker.getInstance().blockIP(ipAddress, userId, reason, expiresAt ? new Date(expiresAt) : undefined);
    ...
    async unblockIP(req, res) {
        try {
            ...
            await administrator_1.IPBlocker.getInstance().unblockIP(ipAddress);
    ...
    async listBlockedIPs(req, res) {
        try {
            ...
            const ips = await administrator_1.IPBlocker.getInstance().getBlockedIPs(Number(page), Number(limit));
            res.json(ips);
        }
        catch (error) {
...
//# sourceMappingURL=ip.controllers.js.map
//# debugId=b58cd2f4-0980-5fa9-a04b-a694d9627051
