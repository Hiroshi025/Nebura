"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e5e3e4be-de57-5424-9ddf-bb56b462da03")}catch(e){}}();
...
async function RouletteCommand(interaction, _client) {
    ...
    if (userBalance.balance <= 0) {
        return interaction.reply({
            embeds: [new embeds_extend_1.ErrorEmbed().setDescription("You don't have enough money to play!")],
            flags: "Ephemeral",
        });
    }
    ...
    const row = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.ButtonBuilder().setCustomId("stop_roulette").setLabel("🛑 Stop Roulette").setStyle(discord_js_1.ButtonStyle.Danger), new discord_js_1.ButtonBuilder().setCustomId("bet_all").setLabel("💰 Bet All").setStyle(discord_js_1.ButtonStyle.Secondary), new discord_js_1.ButtonBuilder().setCustomId("withdraw_winnings").setLabel("🏦 Withdraw").setStyle(discord_js_1.ButtonStyle.Success));
    const updateAccumulatedMessage = async () => {
        const accumulatedEmbed = new embeds_extend_1.EmbedCorrect()
        ...
        if (winnings > 0) {
            ...
            doubleCollector.on("collect", async (btn) => {
                ...
                if (isDoubleWin) {
                    ...
                    const doubleWinEmbed = new embeds_extend_1.EmbedCorrect()
                    ...
                    const doubleLoseEmbed = new embeds_extend_1.ErrorEmbed()
                        .setTitle("💀 Double or Nothing Result")
                        .setDescription(`The roulette stopped at **${doubleResult.color} ${doubleResult.number}**.\n\n` +
...
//# debugId=e5e3e4be-de57-5424-9ddf-bb56b462da03
