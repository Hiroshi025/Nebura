"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="860653a2-2170-52bd-84b2-8c86bcec3d82")}catch(e){}}();

Object.defineProperty(exports, "__esModule", { value: true });
exports.PayEconomy = PayEconomy;
const main_1 = require("../../../../../../../main");
const embeds_extend_1 = require("../../../../../../../shared/adapters/extends/embeds.extend");
const functions_1 = require("../functions");
async function PayEconomy(interaction, client) {
    ...
    const selectedUserBalance = await (0, functions_1.fetchBalance)(user.id, interaction.guild.id);
    amount = await (0, functions_1.toFixedNumber)(amount);
    const balanceFixed = await (0, functions_1.toFixedNumber)(userBalance.balance - amount);
    await main_1.main.prisma.userEconomy.update({
        where: { id: userBalance.id },
        data: { balance: balanceFixed },
    });
    const userBalanceFixed = await (0, functions_1.toFixedNumber)(selectedUserBalance.balance + amount);
    await main_1.main.prisma.userEconomy.update({
    ...
    await userGet.send({
        embeds: [
            new embeds_extend_1.EmbedCorrect()
                .setDescription(`You have received a total of ${amount} from ${interaction.user}! This amount has been deposited to your balance and you total now is $${selectedUserBalance.balance + amount}`)
                .setColor("Green")
...
//# debugId=860653a2-2170-52bd-84b2-8c86bcec3d82
