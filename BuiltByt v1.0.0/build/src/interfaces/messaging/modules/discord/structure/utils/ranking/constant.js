"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="209efc4c-2ca9-568d-8002-c76eb8ce9bdb")}catch(e){}}();

Object.defineProperty(exports, "__esModule", { value: true });
exports.BGM_TRACKS = exports.SPECIAL_REWARDS = exports.ANIME_CARDS = exports.SEASONAL_EVENTS = exports.ANIME_STUDIOS = exports.ANIME_STORIES = exports.ANIME_RANKS = exports.SPAM_PENALTY_XP = exports.MAX_LEVEL = exports.ACHIEVEMENTS = exports.WEEKLY_QUESTS = exports.DAILY_QUESTS = exports.ANIME_THEMES = void 0;
// 📜 Sistema de Rangos Anime v1.0
exports.ANIME_THEMES = {
    SHONEN: '¡Plus Ultra!',
...
exports.DAILY_QUESTS = [
    ...
    },
    {
        ...
        requirement: 3,
        xpReward: 300,
        check: (m, p) => m.channel.name === 'ayuda' && m.content.includes('?') ? p + 1 : p,
        animation: '🛡️🙌'
    },
    {
        ...
        requirement: 5,
        xpReward: 200,
        check: (m, p) => m.mentions.users.size >= 1 ? p + 1 : p,
        animation: '✨👥'
    }
];
exports.WEEKLY_QUESTS = [
    {
        id: 'tournament_arc',
        name: '¡Arco Torneo!',
...
//# debugId=209efc4c-2ca9-568d-8002-c76eb8ce9bdb
