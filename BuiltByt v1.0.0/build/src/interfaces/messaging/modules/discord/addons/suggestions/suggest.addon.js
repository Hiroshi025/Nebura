"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="d77f1ade-56c3-5f46-b11e-e9bf55e4c8f4")}catch(e){}}();
...
const suggest_repositories_1 = require("../../../../../../shared/adapters/gateaway/suggest.repositories");
/**
...
async (client) => {
     ...
     * @type {EmbedConfig}
     */
    const suggestRepository = new suggest_repositories_1.SuggestRepository();
     ...
     */
    async function getLastVoterInfo(guildId, voters, downvoters) {
    ...
    client.on("messageCreate", async (message) => {
        ...
        try {
            ...
            const embed = new discord_js_1.EmbedBuilder()
                ...
                .setColor(myGuild.embedColor && /^#[0-9A-F]{6}$/i.test(myGuild.embedColor)
                ? myGuild.embedColor
                ...
                .addFields({ name: "👍 Up Votes", value: "```0 Votes (0.0%)```", inline: true }, { name: "👎 Down Votes", value: "```0 Votes (0.0%)```", inline: true }, { name: "📊 Progress", value: "```" + createProgressBar(0) + "```", inline: false }, { name: "🆔 Suggested By", value: `<@${message.author.id}>`, inline: true }, { name: "⏱️ Last Voter", value: "```No votes yet```", inline: true });
            // Add image if exists
            ...
            const row1 = new discord_js_1.ActionRowBuilder().addComponents(upvoteButton, downvoteButton, whoButton);
            const row2 = new discord_js_1.ActionRowBuilder().addComponents(approveButton, rejectButton);
            /**
        ...
        try {
            ...
            switch (customId) {
                ...
                case "suggest_reject":
                    ...
                    const statusColor = isApproval ? discord_js_1.Colors.Green : discord_js_1.Colors.Red;
                    ...
                    // Update the message
                    const updatedEmbed = discord_js_1.EmbedBuilder.from(interaction.message.embeds[0])
                    ...
                    // Disable all buttons
                    const disabledUpvote = new discord_js_1.ButtonBuilder()
                        .setCustomId("suggest_upvote")
                        .setEmoji(myGuild.approveEmoji || "👍")
                        .setLabel(suggestion.upvotes.toString())
                        .setStyle(discord_js_1.ButtonStyle.Secondary)
                        .setDisabled(true);
                    const disabledDownvote = new discord_js_1.ButtonBuilder()
                        .setCustomId("suggest_downvote")
                        .setEmoji(myGuild.denyEmoji || "👎")
                        .setLabel(suggestion.downvotes.toString())
                        .setStyle(discord_js_1.ButtonStyle.Secondary)
                        .setDisabled(true);
                    const disabledWho = new discord_js_1.ButtonBuilder()
                        .setCustomId("suggest_who")
                        .setEmoji("❓")
                        .setLabel("Who voted?")
                        .setStyle(discord_js_1.ButtonStyle.Primary)
                        .setDisabled(true);
                    const disabledRow = new discord_js_1.ActionRowBuilder().addComponents(disabledUpvote, disabledDownvote, disabledWho);
            ...
            // Get last voter info
            const lastVoterInfo = await getLastVoterInfo(updatedSuggestion.guildId, updatedSuggestion.voters, updatedSuggestion.downvoters);
            console.debug("[SuggestAddon] Last voter info:", lastVoterInfo);
            const updatedEmbed = discord_js_1.EmbedBuilder.from(interaction.message.embeds[0]).spliceFields(0, 5, {
                name: "👍 Up Votes",
...
//# sourceMappingURL=suggest.addon.js.map
//# debugId=d77f1ade-56c3-5f46-b11e-e9bf55e4c8f4
