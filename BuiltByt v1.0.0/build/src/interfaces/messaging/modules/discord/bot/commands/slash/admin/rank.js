"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="87f29bcd-c173-5987-ad21-996277f06116")}catch(e){}}();
                    ...
                    case "card-background":
                        {
                            try {
                                ...
                                const Buffer = await (0, discord_arts_1.Profile)(targetMember.user.id, {
    ...
    if (subcommand === "use") {
        ...
        await interaction.reply({
            embeds: [
                new embeds_extend_1.EmbedCorrect()
                    .setColor("#087996")
                    .setDescription(`${client.getEmoji(interaction.guild.id, "correct")} The ranking system has been ${status ? "enabled" : "disabled"}.`),
            ],
        });
    }
    return;
...
//# debugId=87f29bcd-c173-5987-ad21-996277f06116
