"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="81677ab5-0e5b-5d03-9572-ac82858031e1")}catch(e){}}();
...
const commandNpm = {
    ...
    async execute(client, message, args, prefix) {
        ...
        const mainEmbed = new discord_js_1.EmbedBuilder()
            ...
            .addFields({ name: "Latest Version", value: pkgData["dist-tags"]?.latest || "Unknown", inline: true }, {
            name: "License",
            ...
            switch (interaction.customId) {
                ...
                case "view_versions": {
                    const versionsEmbed = new discord_js_1.EmbedBuilder()
                        ...
                        .setColor(0xcb3837)
                        .setDescription(Object.entries(pkgData.time || {})
        ...
        selectCollector.on("collect", async (interaction) => {
            ...
            const versionEmbed = new discord_js_1.EmbedBuilder()
                ...
                .setColor(0xcb3837)
                .addFields({ name: "Published", value: pkgData.time?.[selectedVersion] || "Unknown", inline: true }, {
                name: "Dependencies",
...
module.exports = commandNpm;
//# sourceMappingURL=npmv.js.map
//# debugId=81677ab5-0e5b-5d03-9572-ac82858031e1
