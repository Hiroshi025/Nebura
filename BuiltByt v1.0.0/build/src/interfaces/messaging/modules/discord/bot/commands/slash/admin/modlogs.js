"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f8a198de-5e66-5dc6-8435-da218c1bab43")}catch(e){}}();
...
exports.default = new builders_1.Command(new discord_js_1.SlashCommandBuilder()
    ...
    .addChannelTypes(discord_js_1.ChannelType.GuildText)
    .setRequired(true)))
    .addSubcommand((subcommand) => subcommand.setName("delete").setDescription("Deletes config for the modlogs.")), async (client, interaction) => {
    ...
    switch (getSubCommand) {
        case "setup": {
                ...
                return interaction.reply({
                    embeds: [
                        new embeds_extend_1.ErrorEmbed()
                            ...
                            .setDescription([
                            `${client.getEmoji(interaction.guildId, "error")} You need to specify a channel for the modlogs!`,
                            `Please make sure that the channel is a text channel.`,
                        ].join("\n")),
                    ],
                });
            const existingModlog = await main_1.main.prisma.serverModlog.findFirst({
            ...
            await main_1.main.prisma.serverModlog.create({
                data: {
                    guildId: guild.id,
        ...
        case "replace_channel": {
            ...
            await main_1.main.prisma.serverModlog.update({
        ...
        case "delete": {
            ...
            await main_1.main.prisma.serverModlog.delete({
                where: { guildId: guild.id }, // Cambiado de id: existingModlog.id a guildId: guild.id
            });
            await interaction.reply({
                embeds: [
...
//# debugId=f8a198de-5e66-5dc6-8435-da218c1bab43
