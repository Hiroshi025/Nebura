"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="f410b4ed-5eca-5e1f-b1a7-7801f99db985")}catch(e){}}();
        ...
        if (componentInteraction.isButton()) {
            if (componentInteraction.customId === "save-configuration") {
                await main_1.main.prisma.myGuild.upsert({
                    ...
                    create: {
                        guildId,
                        discordId: config_1.config.modules.discord.id,
                        [selectedConfigSlot]: selectedVoiceChannelId,
                        [selectedConfigSlot.replace("channel", "message")]: customMessage,
                    },
                });
...
//# debugId=f410b4ed-5eca-5e1f-b1a7-7801f99db985
