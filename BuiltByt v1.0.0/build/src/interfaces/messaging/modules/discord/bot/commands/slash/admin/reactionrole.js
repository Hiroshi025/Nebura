"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="abdf4f0b-cc30-511d-9da2-21d565208d1e")}catch(e){}}();
...
exports.default = new builders_1.Command(new discord_js_1.SlashCommandBuilder()
    ...
    try {
        if (!interaction.guild || !interaction.channel || interaction.channel.type !== discord_js_1.ChannelType.GuildText)
            return;
        const guildId = interaction.guild.id;
        const dataClient = await main_1.main.DB.findClient(DB_1.clientID);
...
//# debugId=abdf4f0b-cc30-511d-9da2-21d565208d1e
