"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="9c5f02f2-be30-5107-a7fc-988e04ae52db")}catch(e){}}();
            ...
            case "add":
                    ...
                    return message.reply({
                        embeds: [
                            new discord_js_1.EmbedBuilder()
                                ...
                                .addFields({ name: "Example", value: "`timeout add @user 30m Spamming`" }, { name: "Time Formats", value: "`30m` (30 minutes), `2h` (2 hours), `1d` (1 day)" })
                        ]
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            new discord_js_1.EmbedBuilder()
                                ...
                                .addFields({ name: "Valid Formats", value: "`m` (minutes), `h` (hours), `d` (days)" }, { name: "Examples", value: "`30m`, `2h`, `1d`" })
                        ]
                    });
                }
                ...
                try {
                    ...
                    const embed = new discord_js_1.EmbedBuilder()
                        ...
                        .addFields({ name: "Reason", value: reason, inline: true }, { name: "Duration", value: formatDuration(duration), inline: true }, { name: "Moderator", value: message.author.toString(), inline: true })
                    ...
                    collector.on("collect", async (i) => {
                        if (i.customId === `untimeout_${targetUser.id}`) {
                            if (!i.memberPermissions?.has(discord_js_1.PermissionFlagsBits.ModerateMembers)) {
                                return i.reply({
                                    embeds: [
                                        new discord_js_1.EmbedBuilder()
                                            .setColor("#FF0000")
                ...
                collector.on("collect", async (i) => {
                    if (i.isStringSelectMenu() && i.customId === "timeout_details") {
                        ...
                        const detailsEmbed = new discord_js_1.EmbedBuilder()
                            ...
                            .addFields({ name: "User", value: member.toString(), inline: true }, { name: "ID", value: member.id, inline: true }, { name: "Timeout Ends", value: `<t:${Math.floor(timeoutEnds.getTime() / 1000)}:f>`, inline: true }, { name: "Time Remaining", value: formatDuration(timeLeft), inline: true });
                ...
                return message.reply({
                    embeds: [
                        new discord_js_1.EmbedBuilder()
                            ...
                            .addFields({ name: "Add Timeout", value: "`timeout add @user 30m [reason]`", inline: true }, { name: "Remove Timeout", value: "`timeout remove @user`", inline: true }, { name: "List Timeouts", value: "`timeout list`", inline: true }, { name: "Time Formats", value: "`m` (minutes), `h` (hours), `d` (days)", inline: false }, { name: "Examples", value: "`30m` (30 minutes)\n`2h` (2 hours)\n`1d` (1 day)", inline: false })
                    ]
                });
        }
        return;
...
//# debugId=9c5f02f2-be30-5107-a7fc-988e04ae52db
