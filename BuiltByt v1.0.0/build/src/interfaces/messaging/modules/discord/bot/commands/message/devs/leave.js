"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="e306e68e-71f8-5474-ba03-62fe90ce8730")}catch(e){}}();
...
const leaveCommand = {
    ...
    async execute(client, message, args, prefix) {
        ...
        try {
            ...
            return await sendError(message, "Leave failed", `An error occurred while trying to leave guild \`${guild.name}\``);
        }
    },
};
...
async function sendUsage(message, prefix) {
...
async function sendError(message, title, description) {
    return message.channel.send({
        embeds: [new embeds_extend_1.ErrorEmbed().setTitle(`❌ ${title}`).setDescription(description)],
    });
}
async function sendConfirmation(message, guild, prefix) {
    ...
    const confirmButton = new discord_js_1.ActionRowBuilder().addComponents(new discord_js_1.ButtonBuilder()
...
async function sendSuccess(message, guild) {
    return message.channel.send({
        embeds: [
            new embeds_extend_1.EmbedCorrect()
                .setTitle("✅ Left Guild Successfully")
...
//# debugId=e306e68e-71f8-5474-ba03-62fe90ce8730
