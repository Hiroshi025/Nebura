"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0b97b26d-5f29-514a-bf0b-985f29d83af7")}catch(e){}}();
...
class IPBlocker {
    ...
    async loadBlockedIPs() {
        try {
            (0, console_1.logWithLabel)("custom", "Loading blocked IPs...", {
                customLabel: "IP",
            });
            const now = new Date();
            ...
            (0, console_1.logWithLabel)("custom", `Error loading blocked IPs: ${error}`, {
                customLabel: "IP",
                context: {
                    error: error,
    ...
    async autoUnblockExpiredIPs() {
        try {
            ...
            if (expiredBlocks.length > 0) {
                (0, console_1.logWithLabel)("custom", `${expiredBlocks.length} expired IP blocks have been automatically unblocked.`, {
                    customLabel: "IP",
                });
            }
        }
        catch (error) {
            (0, console_1.logWithLabel)("custom", `Error during auto-unblock of expired IPs: ${error}`, {
                customLabel: "IP",
                context: {
                    error: error,
                    blockedIPs: this.blockedIPs,
...
//# debugId=0b97b26d-5f29-514a-bf0b-985f29d83af7
