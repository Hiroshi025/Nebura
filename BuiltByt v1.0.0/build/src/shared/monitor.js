"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="5d7ee940-a99e-592f-843b-bd3f04bdf469")}catch(e){}}();
...
const SwaggerMonitor = (main) => {
    ...
    swagger_parser_1.default.prototype.validate(projectconfig.local, function (err, api) {
        if (!err) {
            ...
            (0, console_1.logWithLabel)("custom", `Swagger API: ${err}`, {
                customLabel: "Swagger",
            });
            return;
        }
...
//# debugId=5d7ee940-a99e-592f-843b-bd3f04bdf469
