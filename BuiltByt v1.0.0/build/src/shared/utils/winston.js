"use strict";
!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="a38dc226-1a54-5322-8e40-a4efda22c177")}catch(e){}}();
...
class WinstonLogger {
    ...
    constructor(maxLogAgeDays = 14) {
        this.logDir = path_1.default.resolve(process.env.WINSTON_LOG_DIR ? process.env.WINSTON_LOG_DIR : "./config/logs-apps/proyect");
        ...
        this.logger = winston_1.default.createLogger({
            ...
            transports: [
                new winston_1.default.transports.DailyRotateFile({
                    ...
                    format: winston_1.default.format.combine(winston_1.default.format.timestamp({ format: "YYYY-MM-DD HH:mm:ss.SSS" }), winston_1.default.format.printf(({ timestamp, level, message, category }) => {
                        return `[${timestamp}] [${level}]${category ? ` [${category}]` : ""} ${message}`;
                    })),
                }),
            ],
...
//# debugId=a38dc226-1a54-5322-8e40-a4efda22c177
