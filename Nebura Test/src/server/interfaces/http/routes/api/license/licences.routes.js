...
const auth_middleware_1 = require("../../../../../shared/middlewares/jwt/auth.middleware");
...
exports.default = ({ app }) => {
     ...
     */
    app.post(formatRoute("/validate/:key"), rateLimit_1.RateLimitManager.getInstance().createCustomLimiter({
        max: 10,
        windowMs: 60 * 1000, // 1 minuto
        message: "Too many requests, please try again later.",
