    ...
    async execute(_client, message, args) {
        ...
        try {
            ...
            const targetUser = message.mentions.users.first() ||
                message.guild.members.cache.find((m) => m.user.username.toLowerCase() === userArg.toLowerCase() ||
                    m.displayName.toLowerCase() === userArg.toLowerCase())?.user ||
            ...
            const embed = new embeds_extender_1.EmbedCorrect()
                ...
                .addFields({ name: "Username", value: (0, discord_js_1.inlineCode)(targetUser.tag), inline: true }, { name: "ID", value: targetUser.id, inline: true }, { name: "Bot", value: targetUser.bot ? "Yes" : "No", inline: true }, {
                name: "Joined Server",
