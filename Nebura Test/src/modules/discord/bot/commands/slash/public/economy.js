...
const coinflip_1 = require("../../../../../../modules/discord/structure/utils/economy/coinflip");
const daily_1 = require("../../../../../../modules/discord/structure/utils/economy/daily");
const duelo_1 = require("../../../../../../modules/discord/structure/utils/economy/duelo");
const inventory_1 = require("../../../../../../modules/discord/structure/utils/economy/inventory");
const pay_1 = require("../../../../../../modules/discord/structure/utils/economy/pay");
const roulette_1 = require("../../../../../../modules/discord/structure/utils/economy/roulette");
const rps_1 = require("../../../../../../modules/discord/structure/utils/economy/rps");
const shop_1 = require("../../../../../../modules/discord/structure/utils/economy/shop");
const slots_1 = require("../../../../../../modules/discord/structure/utils/economy/slots");
const state_1 = require("../../../../../../modules/discord/structure/utils/economy/state");
exports.default = new builders_1.Command(new discord_js_1.SlashCommandBuilder()
    ...
    if (group) {
        ...
        switch (subcommand) {
            case "balance":
                {
                    await balance_1.BalanceCommand.Interaction(interaction, client);
                }
                break;
            case "daily":
                {
            ...
            case "state":
                {
                    await (0, state_1.StateCommand)(interaction, client);
                }
                break;
        }
    }
