...
exports.default = new builders_1.Command(new discord_js_1.SlashCommandBuilder()
    ...
    switch (interaction.options.getSubcommand()) {
        case "add":
            {
                ...
                if (modData) {
                    ...
                    channel.send({
                        embeds: [
                            new embeds_extender_1.EmbedCorrect().setTitle("New user warned").addFields({
                                name: "User warned",
                                value: `<@${user.id}>`,
                                inline: true,
                            }, {
        ...
        case "remove": {
            ...
            const err = new embeds_extender_1.EmbedCorrect().setDescription(`No warn Id watching \`${warnId}\` was found!`);
            if (!data)
