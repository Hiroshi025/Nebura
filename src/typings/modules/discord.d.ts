...
export interface Precommand {
  ...
  category?: string;
  /**
   * Localized names for the precommand.
   *
   * @remarks
   * This property allows you to provide translations for the command name in different languages.
   * The keys should be [BCP 47 language tags](https://tools.ietf.org/html/bcp47) (e.g., "en-US", "es-ES").
   *
   * @example
   * ```ts
   * nameLocalizations: {
