...
import {
	CoinflipCommand
} from "@/interfaces/messaging/modules/discord/structure/utils/economy/coinflip";
import { DailyCommand } from "@/interfaces/messaging/modules/discord/structure/utils/economy/daily";
import { DueloCommand } from "@/interfaces/messaging/modules/discord/structure/utils/economy/duelo";
import {
	InventoryCommand
} from "@/interfaces/messaging/modules/discord/structure/utils/economy/inventory";
import { PayEconomy } from "@/interfaces/messaging/modules/discord/structure/utils/economy/pay";
import {
	RouletteCommand
} from "@/interfaces/messaging/modules/discord/structure/utils/economy/roulette";
import { RPSCommand } from "@/interfaces/messaging/modules/discord/structure/utils/economy/rps";
import { ShopEconomy } from "@/interfaces/messaging/modules/discord/structure/utils/economy/shop";
import { SlotsCommand } from "@/interfaces/messaging/modules/discord/structure/utils/economy/slots";
import {
	StateCommand
} from "@/interfaces/messaging/modules/discord/structure/utils/economy/status";
import {
