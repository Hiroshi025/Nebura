...
import { Event } from "@messaging/modules/discord/structure/utils/builders";
import { EmbedCorrect, ErrorEmbed } from "@shared/utils/extends/embeds.extension";
...
export default new Event("interactionCreate", async (interaction) => {
  ...
  if (interaction.customId === "reviewSetup") {
    ...
    // Validate lengths
    if (isNaN(minReviewLength) || isNaN(maxReviewLength) || minReviewLength < 1 || maxReviewLength < minReviewLength) {
      return interaction.reply({
